...
<head>
    ...
    <title>ITC Grand Central Conference Hall</title>
    <style>
        body {
...
<body>
    ...
    // Get hall details
    $hall_query = "SELECT * FROM conference_hall WHERE Hall_id = 3";
    $hall_result = $conn->query($hall_query);
    $hall_data = $hall_result->fetch_assoc();

    // Get room details
    $room_query = "SELECT * FROM conference_room WHERE Hall_id = 3";
    $room_result = $conn->query($room_query);
    ?>

    <div class="container">
        <div class="hall-header">
            <img src="https://www.itchotels.com/content/dam/itchotels/in/umbrella/itc/hotels/itcgrandcentral-mumbai/images/meetings-and-socials-landing-page/headmast/desktop/banquet-meeting.png" alt="<?php echo $hall_data['Hall_name']; ?>">
        ...
        <div class="room-grid">
            ...
            ?>
            <div class="room-card">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSk5IgEk55RMa_9r-RiO1fF3q-3ecx1QNwKa2MTQxSiF6guj_K4iLGfAVU&s=10" alt="Room <?php echo $room['Room_id']; ?>" class="room-image">
                <div class="room-info">
                ...
                <a href="Services.php?room_id=<?php echo $room['Room_id']; ?>&hall_id=3" class="btn services-btn">Add Services</a>
                </div>
            </div>
            <?php
            }
