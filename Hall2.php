...
<head>
    ...
    <title>The Oberoi Conference Center</title>
    <style>
        body {
...
<body>
    ...
    // Get hall details
    $hall_query = "SELECT * FROM conference_hall WHERE Hall_id = 2";
    $hall_result = $conn->query($hall_query);
    $hall_data = $hall_result->fetch_assoc();

    // Get room details
    $room_query = "SELECT * FROM conference_room WHERE Hall_id = 2";
    $room_result = $conn->query($room_query);
    ?>

    <div class="container">
        <div class="hall-header">
            <img src="https://www.oberoihotels.com/-/media/oberoi-hotels/website-images/the-oberoi-gurgaon/events/details/togn-business-centre-16-seater-meeting-room.jpg" alt="<?php echo $hall_data['Hall_name']; ?>">
        ...
        <div class="room-grid">
            ...
            ?>
            <div class="room-card">
                <img src="https://www.oberoihotels.com/-/media/oberoi-hotels/website-images/the-oberoi-gurgaon/events/details/ballroom-2-parts-still---high.jpg" alt="Room <?php echo $room['Room_id']; ?>" class="room-image">
                <div class="room-info">
                ...
                <a href="Services.php?room_id=<?php echo $room['Room_id']; ?>&hall_id=2" class="btn services-btn">Add Services</a>
                </div>
            </div>
            <?php
            }
