...
<body>
    ...
    <nav>
        <ul>
            <li><a href="conference_hall.php">Conference Halls</a></li> 
            <li><a href="My_Bookings_client.php">Bookings</a></li>
            ...
            <div class="search-section">
                ...
                if(isset($_POST['search'])) {
                    ...
                    if($searchType == 'date' && !empty($_POST['searchDate'])) {
                        ...
                        $query = "SELECT DISTINCT cr.*, ch.Hall_name 
                        ...
                        $query = "SELECT cr.*, ch.Hall_name 
                                FROM conference_room cr
                                JOIN conference_hall ch ON cr.Hall_id = ch.Hall_id WHERE ";
                        if($capacity == "10") {
                            $query .= "Capacity <= 10";
                        } else if($capacity == "50") {
                            $query .= "Capacity > 10 AND Capacity <= 50";
                        } else {
                            $query .= "Capacity > 50 AND Capacity <= 100";
                        }
                    }
