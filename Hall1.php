...
<head>
    ...
    <title>Taj Lands End Conference Hall</title>
    <style>
        body {
...
<body>
    ...
    // Get hall details
    $hall_query = "SELECT * FROM conference_hall WHERE Hall_id = 1";
    $hall_result = $conn->query($hall_query);
    $hall_data = $hall_result->fetch_assoc();

    // Get room details
    $room_query = "SELECT * FROM conference_room WHERE Hall_id = 1";
    $room_result = $conn->query($room_query);
    ?>

    <div class="container">
        <div class="hall-header">
            <img src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1a/3d/41/dd/mansion-social-event.jpg" alt="<?php echo $hall_data['Hall_name']; ?>">
        ...
        <div class="room-grid">
            ...
            ?>
            <div class="room-card">
                <img src="https://www.exoticadubai.tajhotels.com/wp-content/uploads/sites/470/2022/07/Aqua-Boardroom2.jpg" alt="Room <?php echo $room['Room_id']; ?>" class="room-image">
                <div class="room-info">
                ...
                <div class="button-container">
                    <a href="Services.php?room_id=<?php echo $room['Room_id']; ?>&hall_id=1" class="btn services-btn">Add Services</a>
                </div>
            </div>
            <?php
            }
